...
public class Mago extends Jugador{
    ...
    public Mago (String Mago_nombre){
        this.nombre = Mago_nombre;
        this.vida = 10;
        this.xp = 0;
        this.fuerza = 3;
    ...
    @Override
    public int ataque() {
        int Ataque = this.fuerza * (this.inteligencia/4) + this.energia;
    ...
    public void subir_experiencia(int experiencia) {
        ...
        if (nivel_Actual < Nivel()){
            this.vida = this.vida + (2 * nivel_Actual);
            this.fuerza = this.fuerza + 1;
            this.inteligencia = this.inteligencia + (3 * nivel_Actual);
            this.energia = this.energia + 1;
            this.mana = this.mana + (3 * nivel_Actual);
        }
    }
}
